...
const radio = document.querySelectorAll('.formio-component-radio, .formio-component-selectboxes, .formio-component-selectboxes')

// Fields Animation 

const textFields = document.querySelectorAll(
  ".formio-component-textfield:not(.formio-component-multiple) input, .formio-component-number:not(.formio-component-multiple) input, .formio-component-email input, .formio-component-datetime .flatpickr-input, .formio-component-textarea textarea"
);
...
dropdownFields.forEach(function (select) {
  const label = select.parentNode.parentNode.parentNode.querySelector(
    'label[for="' + select.id + '"]'
  );
...
const multiFields = document.querySelectorAll(
  ".formio-component-multiple:not(.formio-component-select) input"
);
