...
function handleOptionClick(yesSelector, noSelector, countrySelector) {
  // Check if the country components have the 'required' class
  var isCountryRequired = $(countrySelector).hasClass('required');

  // Set the initial visibility based on the 'required' class
  if (!isCountryRequired) {
    $(countrySelector).css('visibility', 'hidden');
  }

  $(yesSelector).click(function() {
    $(countrySelector).css('visibility', 'visible');
    $(countrySelector).addClass('required');
    $(yesSelector).removeClass('required custom-error formio-error-wrapper');
  ...
  $(noSelector).click(function() {
    $(countrySelector).css('visibility', 'hidden');
    $(countrySelector).removeClass('required custom-error formio-error-wrapper');
    $(yesSelector).removeClass('required custom-error formio-error-wrapper');
    setTimeout(checkError, 1)
  });
}
...
handleOptionClick(".formio-component-realYes", ".formio-component-realNo", ".formio-component-realCountry");
handleOptionClick(".formio-component-comYes", ".formio-component-comNo", ".formio-component-comCountry");
handleOptionClick(".formio-component-eqYes", ".formio-component-eqNo", ".formio-component-eqCountry");
handleOptionClick(".formio-component-fixYes", ".formio-component-fixNo", ".formio-component-fixCountry");
