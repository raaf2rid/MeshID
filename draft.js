...
/* Autofill Custom */
  ...
  .middle .intro-box:hover {
    background-color: rgba(206,98,157,0.8);
  }
  ...
  .preview .meshid-custom .formio-error-wrapper label {
...
.preview .page-title{
 background: rgb(209,84,149) !important; 
 background: radial-gradient(circle, #ce629d 10%, #317aa3 200%);
 background: linear-gradient(145deg, #c2207e 0%, #019dcd 100%) !important;
}
