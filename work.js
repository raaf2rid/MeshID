...
/* Autofill Custom */
  ...
  .preview .argentex .formio-component-select:not(.formio-component-code) label
  {
    transition: 250ms;
    z-index: 1000;
    font-weight: 700;
...
backBtn.forEach(item=>{
  ...
  const textFields = document.querySelectorAll('.formio-component-textfield:not(.formio-component-multiple) input, .formio-component-email input, .formio-component-datetime .flatpickr-input');
